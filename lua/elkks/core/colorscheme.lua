...
-- INFO: MIASMA
--
-- local status, colorscheme = pcall(vim.cmd, "colorscheme miasma")
-- if not status then
-- 	print("no se encontró miasma")
-- 	return
-- end

-- INFO: MELANGE
--
-- local status, colorscheme = pcall(vim.cmd, "colorscheme melange")
-- if not status then
-- 	print("no se encontró melange")
-- 	return
-- end

-- INFO: GRUVBOX MATERIAL

-- local status, colorscheme = pcall(vim.cmd, "colorscheme gruvbox-material")
-- if not status then
-- 	print("no se encontró carbon")
-- 	return
-- end
...
-- INFO: DARKEARTH
--
-- local status, colorscheme = pcall(vim.cmd, "colorscheme darkearth")
-- if not status then
-- 	print("no se encontró moonbow")
-- 	return
-- end
...
-- INFO: CARBON
--
-- local status, colorscheme = pcall(vim.cmd, "colorscheme carbon")
-- if not status then
-- 	print("no se encontró carbon")
-- 	return
-- end
...
-- if not status then
-- 	print("no se encontró catppuccin")
-- 	return
-- end
--
-- colorscheme.setup({
